...
function App() {
  ...
  return (
    <div>
      ...
      <main>
        <section id="home" className="hero">
          ...
          <div className="hero-content">
            <p className="eyebrow">
              YAM ASSOCIATES • ADVOCATES & LEGAL CONSULTANTS
            </p>

            <h1>
              Legal Solutions.
              <br />
              <em>Strategic Representation.</em>
            </h1>
            ...
            <div className="actions">
              <a className="button gold" href="#appointment">
                Book Consultation — ₹699
              </a>

              <a className="button outline" href="#status">
                Check Case Status
              </a>
            </div>
        ...
        <section id="process" className="section process">
          ...
          <div className="steps">
            <div>
              ...
              <h3>Book</h3>
              <p>
                Submit your consultation details and choose a preferred
                appointment.
              </p>
            </div>
            ...
            <div>
              ...
              <h3>Pay ₹699</h3>
              <p>
                Complete the consultation payment through the connected
            ...
            <div>
              <b>03</b>
              <h3>Get your Client Code</h3>
              <p>
                A unique reference code will be generated after successful
                booking.
              </p>
            </div>
        ...
        <section id="contact" className="contact section">
          ...
          <div className="contact-details">
            ...
            <p>
              Consultation: <strong>₹699</strong>
            </p>
      ...
      <footer>
        © {new Date().getFullYear()} YAM Associates. All rights reserved.
      </footer>
    </div>
  );
}
